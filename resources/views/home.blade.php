  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="login">User Login  <i class="fa fa-user"></i></a></li>
        <li><a href="oficial">Official Login  <i class="fa fa-user"></i></a></li>
      </ul>
    </div>
  </div>
 </nav>
 	...
 	<div class="row">
 		<div class="col-lg-12">
 			<div class="content">
 				...
 				<hr>
          <a href="register" class="btn btn-default btn-lg" role="button" aria-pressed="true">Sign Up!</a>
 			</div>
 		</div>
 	</div>
 </div>
