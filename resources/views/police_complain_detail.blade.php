  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li ><a href="police_pending_complain">View Complaints</a></li>
        <li class="active" ><a href="police_complain_detail">Complaints Details</a></li>
  ...
  <div style="width: 100%; height: 250px;"> 
    ...
    <div style="width: 50%;float: left;height: 250px; background-color: #dcdcdc"> 
     ...
     <form method="post">
      ...
      <input type="text" name="cid" style="margin-left: 47%; width: 50px;" disabled value="">
